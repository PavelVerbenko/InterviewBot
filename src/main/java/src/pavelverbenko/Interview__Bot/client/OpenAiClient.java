package src.pavelverbenko.Interview__Bot.client;
...
import src.pavelverbenko.Interview__Bot.ai.GptRequest;
import src.pavelverbenko.Interview__Bot.ai.GptResponse;
import src.pavelverbenko.Interview__Bot.ai.Transcription;

import java.io.File;
import java.util.List;

//Тут всё у нас для работы с ИИ
//Делает промт, делает запрос, возвращает ответ в json формате, который мы потом преобразуем в текст
@Component
